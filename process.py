...
data1 = pd.read_csv(r'C:\Users\kicph\python_code\ECE143\project\ECE143Project\Combine\full_result.csv')
...
#create a query to show time range 
    ...
    print(data_yr1)
    data_yr1.to_csv(r'C:\Users\kicph\python_code\ECE143\project\ECE143Project\select\yr' + st +'-' +ed + '_data_partial.csv')
